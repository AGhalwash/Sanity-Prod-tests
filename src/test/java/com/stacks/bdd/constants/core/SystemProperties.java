...
public class SystemProperties {
    ...
    private SystemProperties() throws MalformedURLException {
    ...
    public static String getServerUrl(String url) {
        ...
        switch (url) {
            case "Demo":
                serverUrl = SYSTEM_PROPS.getProperty("selenium.server.url.demo");
                break;
            case "US":
                serverUrl = SYSTEM_PROPS.getProperty("selenium.server.url.us");
                break;
            case "IDN":
                serverUrl = SYSTEM_PROPS.getProperty("selenium.server.url.idn");
                break;
            case "MOE":
                serverUrl = SYSTEM_PROPS.getProperty("selenium.server.url.moe");
                break;
            case "Schools":
                serverUrl = SYSTEM_PROPS.getProperty("selenium.server.url.schools");
                break;
            default:
                throw new IllegalArgumentException("Environment is not available");
        }
	...
	public static URL getSeleniumGridUrl() {
		String seleniumGridUrl = SYSTEM_PROPS.getProperty("selenium.grid.url.demo");
